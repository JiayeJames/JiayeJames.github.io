...
class Brick(pygame.sprite.Sprite):
	def __init__(self):
		...
		self.brick = pygame.image.load('D:\Others\PythonPrograms\Tank/图片/scene/brick.png')
...
class Iron(pygame.sprite.Sprite):
	def __init__(self):
		pygame.sprite.Sprite.__init__(self)
		self.iron = pygame.image.load('D:\Others\PythonPrograms\Tank/图片/scene/iron.png')
...
class Ice(pygame.sprite.Sprite):
	def __init__(self):
		pygame.sprite.Sprite.__init__(self)
		self.ice = pygame.image.load('D:\Others\PythonPrograms\Tank/图片/scene/ice.png')
...
class River(pygame.sprite.Sprite):
	def __init__(self, kind=None):
		...
		self.rivers = ['D:\Others\PythonPrograms\Tank/图片/scene/river1.png', 'D:\Others\PythonPrograms\Tank/图片/scene/river2.png']
...
class Tree(pygame.sprite.Sprite):
	def __init__(self):
		pygame.sprite.Sprite.__init__(self)
		self.tree = pygame.image.load('D:\Others\PythonPrograms\Tank/图片/scene/tree.png')
