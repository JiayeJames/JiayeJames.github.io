...
def show_start_interface(screen, width, height):
	tfont = pygame.font.Font('D:\Others\PythonPrograms\Tank/font/simkai.ttf', width//4)
	cfont = pygame.font.Font('D:\Others\PythonPrograms\Tank/font/simkai.ttf', width//20)
...
def show_end_interface(screen, width, height, is_win):
	bg_img = pygame.image.load("D:\Others\PythonPrograms\Tank\图片/others/background.png")
	screen.blit(bg_img, (0, 0))
	if is_win:
		font = pygame.font.Font('D:\Others\PythonPrograms\Tank/font/simkai.ttf', width//10)
		content = font.render(u'恭喜通关！', True, (255, 0, 0))
		rect = content.get_rect()
		rect.midtop = (width/2, height/2)
		screen.blit(content, rect)
	else:
		fail_img = pygame.image.load("D:\Others\PythonPrograms\Tank/图片/others/gameover.png")
...
def main():
	...
	while not is_gameover:
		...
		myhome = home.Home()
		# 出场特效
		appearance_img = pygame.image.load("D:\Others\PythonPrograms\Tank/图片/others/appear.png").convert_alpha()
		appearances = []
