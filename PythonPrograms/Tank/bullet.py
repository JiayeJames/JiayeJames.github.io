...
class Bullet(pygame.sprite.Sprite):
	def __init__(self):
		...
		# 子弹四个方向(上下左右)
		self.bullets = ['D:\Others\PythonPrograms\Tank/图片/bullet/bullet_up.png', 'D:\Others\PythonPrograms\Tank/图片/bullet/bullet_down.png', 'D:\Others\PythonPrograms\Tank/图片/bullet/bullet_left.png', 'D:\Others\PythonPrograms\Tank/图片/bullet/bullet_right.png']
		# 子弹方向(默认向上)
