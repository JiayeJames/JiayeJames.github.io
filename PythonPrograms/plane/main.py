...
class Boss(Sprite):
    def __init__(self,boss_img_name):
        super().__init__()
        # 加载BOSS图片
        self.image = pygame.image.load('D:\Others\PythonPrograms\plane\图片/'+boss_img_name+'.png').convert_alpha()
        # 转换BOSS大小
...
class Enemy(Sprite):
    def __init__(self,screen):
        ...
        # 随机 加载五个飞机中的某个
        self.image = pygame.image.load('D:\Others\PythonPrograms\plane\图片/alien_' + str(alien_num) + '.png')
        ...
        self.score = 10
        # 加载子弹的图片
        self.bullet_img = pygame.image.load("D:\Others\PythonPrograms\plane\图片/alien_bullet.png").convert_alpha()
...
class Enemy_Bullet(pygame.sprite.Sprite):
    def __init__(self, init_pos):
        ...
        self.image = pygame.image.load("D:\Others\PythonPrograms\plane\图片/alien_bullet.png").convert_alpha()
...
class MyHero(Sprite):
    ...
    def __init__(self,screen,size = 1):
        ...
        self.screen = screen
        # 获取整张图片
        self.image_big = pygame.image.load('D:\Others\PythonPrograms\plane\图片/hero.png').convert_alpha()
        ...
        #玩家所有发射子弹的集合
        self.bullets = Group()
        self.bullet_image = pygame.image.load('D:\Others\PythonPrograms\plane\图片/bullet_1.png').convert_alpha()
    ...
    def set_air(self, case):
        if case == 'up':
            air = pygame.image.load('D:\Others\PythonPrograms\plane\图片/air.png').convert_alpha()
...
# 设置游戏背景图片
# 游戏刚开始时的背景图
bg_img0 = pygame.image.load('D:\Others\PythonPrograms\plane\图片/start_bg.jpg').convert()
# 加载游戏开始图标
start_img = pygame.image.load('D:\Others\PythonPrograms\plane\图片/start.png').convert_alpha()
start_rect = start_img.get_rect()
start_rect.centerx = 262
start_rect.centery = 455
#  游戏进行中的背景图
bg_img1 = pygame.image.load('D:\Others\PythonPrograms\plane\图片/map1.jpg').convert()
bg_img2 = bg_img1.copy()
# 游戏结束时的背景图
bg_img3 = pygame.image.load('D:\Others\PythonPrograms\plane\图片/map3.jpg').convert()
# 加载游戏结束图标
gameover_img = pygame.image.load('D:\Others\PythonPrograms\plane\图片/gameover.png').convert_alpha()
# 加载游戏成功图标
gamesuccess = pygame.image.load('D:\Others\PythonPrograms\plane\图片/success.png').convert_alpha()

# 加载重玩图标
restart_img = pygame.image.load('D:\Others\PythonPrograms\plane\图片/restart.png').convert_alpha()
...
score = 0
# 设置系统字体
my_font = pygame.font.Font('D:\Others\PythonPrograms\plane\\fonts/msyh.ttf', 18)
