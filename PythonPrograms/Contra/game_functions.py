...
def check_keyup_events(event,player):
	if event.key == pygame.K_d:#右
		player.image = pygame.image.load('D:\Others\PythonPrograms\Contra\Pictures/PR/player.png')
		player.moving_right = False
		player.player_moving = False
	elif event.key == pygame.K_a:#左
		player.image = pygame.image.load('D:\Others\PythonPrograms\Contra\Pictures/PL/player.png')
		player.player_moving = False
		player.moving_left = False
